...
http.createServer((request, response) => {
  if (request.url === '/') {
    response.writeHead(302, { Location: '/boxedwine.html?root=tinycore-wine11.zip&app=netduke32.zip&p=netduke32.exe&args=-nosetup%20-g%20DUKE3D.GRP&resolution=1024x768' });
    return response.end();
  }

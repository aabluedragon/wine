...
http.createServer((req, res) => {
  ...
  if (req.url === '/') { res.writeHead(302, { Location: '/boxedwine.html?root=tinycore-wine11.zip&app=netduke32.zip&p=run.bat&args=-nosetup%20-g%20DUKE3D.GRP%20-v1%20-l1%20-s3&resolution=640x480&env=%22WINEDLLOVERRIDES:mscoree,mshtml=%22&runtime=2&jit-record=true' }); return res.end(); }
